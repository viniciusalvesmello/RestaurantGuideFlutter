class ZomatoSearchModel {
  ...
  ZomatoSearchModel.fromJson(Map<String, dynamic> json) {
...
class Restaurant {
  ...
  Restaurant.fromJson(Map<String, dynamic> json) {
    ...
    if (json['establishment_types'] != null) {
      establishmentTypes = new List<Null>();
      json['establishment_types'].forEach((v) {
        establishmentTypes.add(new Null.fromJson(v));
      });
    }
  }
